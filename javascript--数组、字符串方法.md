...
如果有第二个参数，那第二个参数表示数组的长度  
	...
	var str = "123456747895";
	console.log(str.split("4"));//["123", "567", "7895"]
 ...
 **参数问题**   
 参数：1个 表示要获取字符串的下标  
 如果不写参数，默认返回字符串第一位的字符  
 	
 	var str = "nihao123";
	console.log(str.charAt(0));//n
	console.log(str.charAt());//n   
	   
#### charCodeAt() `返回下标位置对应字符的Unicode编码`  
...
2.替换的字符串  
	...
	var str = "高考分数300分";
	console.log(str.replace("300","700"));  
#### toLowerCase() `把原字符串转换为小写  不会改变原字符串`  
...
#### toUpperCase() `把字符串转换为大写  不会改变原字符串`  
**参数问题**   
没有参数  
